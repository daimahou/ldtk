...
// 			var count = M.ceil(td.pxWid/td.tileGridWid) * M.ceil(td.pxHei/td.tileGridHei);
// 			var tileset = Xml.createElement("tileset");
// 			map.addChild(tileset);
// 			tileset.set("firstgid",""+gid);
// 			tileset.set("name", td.identifier);
// 			tileset.set("tilewidth", ""+td.tileGridWid);
// 			tileset.set("tileheight", ""+td.tileGridHei);
// 			tileset.set("tilecount", "" + count);
// 			tileset.set("columns", "" + M.ceil(td.pxWid/td.tileGridWid) );
