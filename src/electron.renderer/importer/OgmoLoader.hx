...
// 			p.defaultGridWidth = readGrid(json.layerGridDefaultWidth, 16);
// 			p.defaultGridHeight = readGrid(json.layerGridDefaultHeight, 16);
...
// 				td.tileGridWid = readGrid({ x:tilesetJson.tileWidth, y:tilesetJson.tileHeight }, 16);
...
// 						layer.gridWid = readGrid(layerJson.gridWid, 16);
// 						layer.gridHei = readGrid(layerJson.gridHei, 16);
// 						layer.intGridValues = [];
